...
This project is a Spring Boot-based microservice for managing job types, job tags, and job tasks in the FSM (Field
Service Management) system. It provides RESTful APIs for CRUD operations and integrates with other FSM modules.
