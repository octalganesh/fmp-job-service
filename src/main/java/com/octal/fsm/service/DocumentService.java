...
public interface DocumentService {
    ...
    PageItem<DocumentDTO.ListResponse> getListOfDocument(Long tenantId,String type, String typeId, String uploadedByType, String uploadByTypeId, String fileType, int page, int size, String sortBy, Boolean order, String documentTypeId, String loggedInUserEmail) throws CodeException;
